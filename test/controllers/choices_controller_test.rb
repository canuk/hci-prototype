...
class ChoicesControllerTest < ActionController::TestCase
  ...
  test "should create choice" do
    assert_difference('Choice.count') do
      post :create, choice: { order: @choice.order, prompt_id: @choice.prompt_id, text: @choice.text, user_id: @choice.user_id }
    end
  ...
  test "should update choice" do
    patch :update, id: @choice, choice: { order: @choice.order, prompt_id: @choice.prompt_id, text: @choice.text, user_id: @choice.user_id }
    assert_redirected_to choice_path(assigns(:choice))
  end
