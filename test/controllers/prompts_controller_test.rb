...
class PromptsControllerTest < ActionController::TestCase
  ...
  test "should create prompt" do
    assert_difference('Prompt.count') do
      post :create, prompt: { active: @prompt.active, prompt_type: @prompt.prompt_type, text: @prompt.text, user_id: @prompt.user_id }
    end
  ...
  test "should update prompt" do
    patch :update, id: @prompt, prompt: { active: @prompt.active, prompt_type: @prompt.prompt_type, text: @prompt.text, user_id: @prompt.user_id }
    assert_redirected_to prompt_path(assigns(:prompt))
  end
